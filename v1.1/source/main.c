...
int battery_mark_mode_percent[] = { 85, 10, 5 };
...
void Data_update(void)
{
	...
	printf("\x1b[12;0HPress Start to exit.");

	printf("\x1b[13;0H*BL = Battery Level *BC = Battery Charge");
	printf("\x1b[14;0H-------------------------------------------------");
	printf("\x1b[15;0H[%02d:%02d:%02d]", hours, minutes, seconds);
}
...
void Battery_mark_result(void)
{
	...
	else if (battery_mark_select_num == 2)
	{
		mode_msg[0] = 21;
		mode_msg[1] = 4;
		mode_msg[2] = 17;
	...
	if (news_init_succes)
	{
		...
		u16 message[] = { B,a,t,t,e,r,y,msg_space,m,a,r,k,msg_space,v,_1,msg_4,_0,msg_space,r,e,s,u,l,t,msg_,msg_
...
void Battery_mark_init(void)
{
	...
	printf("\x1b[4;5H-------------------------------------------");
	printf("\x1b[5;5H|             \x1b[36mBattery mark\x1b[30m                |");
	printf("\x1b[6;5H|         Checking service Init           |");
	printf("\x1b[7;5H|  (\x1b[31mRequired\x1b[30m) ptmu service Init ...       |");
	printf("\x1b[8;5H|  (\x1b[31mRequired\x1b[30m) mcu service Init  ...       |");
	printf("\x1b[9;5H|  (\x1b[31mRequired\x1b[30m) apt service Init  ...       |");
	printf("\x1b[10;5H|  (\x1b[34mOptional\x1b[30m) news service Init ...       |");
	printf("\x1b[11;5H|  Set screen light level 5 ...           |");
	printf("\x1b[12;5H|  Set system core limit 30%% ...          |");
	printf("\x1b[13;5H|  Set system core limit 70%% ...          |");
	printf("\x1b[14;5H|  Start cpu load Thread 0 ...            |");
	printf("\x1b[15;5H|  Start cpu load Thread 1 ...            |");
	printf("\x1b[16;5H|                                         |");
	printf("\x1b[17;5H|  State : Initilizing [         ]        |");
	printf("\x1b[18;5H|       Choose battery mark mode          |");
	printf("\x1b[19;5H|                                         |");
	printf("\x1b[20;5H|                                         |");
	printf("\x1b[21;5H|                                         |");
	printf("\x1b[22;5H|                                         |");
	printf("\x1b[23;5H|                                         |");
	printf("\x1b[24;5H|\x1b[32m<Left><Right>\x1b[30mSelect,\x1b[32m<A>\x1b[30mContinu,\x1b[32m<B>\x1b[30mGo back|");
	printf("\x1b[25;5H-------------------------------------------");

	usleep(1000000);
	if (ptmu_init_succes)
	{
		printf("\x1b[7;5H|  (\x1b[31mRequired\x1b[30m) ptmu service Init ... \x1b[32mGood\x1b[30m  |");
		printf("\x1b[17;29H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[7;5H|  (\x1b[31mRequired\x1b[30m) ptmu service Init ... \x1b[31mBad\x1b[30m   |");
	...
	if (mcu_init_succes)
	{
		printf("\x1b[8;5H|  (\x1b[31mRequired\x1b[30m) mcu service Init  ... \x1b[32mGood\x1b[30m  |");
		printf("\x1b[17;30H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[8;5H|  (\x1b[31mRequired\x1b[30m) mcu service Init  ... \x1b[31mBad\x1b[30m   |");
	...
	if (apt_init_succes)
	{
		printf("\x1b[9;5H|  (\x1b[31mRequired\x1b[30m) apt service Init  ... \x1b[32mGood\x1b[30m  |");
		printf("\x1b[17;31H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[9;5H|  (\x1b[31mRequired\x1b[30m) apt service Init  ... \x1b[31mBad\x1b[30m   |");
	...
	if (news_init_succes)
	{
		printf("\x1b[10;5H|  (\x1b[34mOptional\x1b[30m) news service Init ... \x1b[32mGood\x1b[30m  |");
		printf("\x1b[17;32H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[10;5H|  (\x1b[34mOptional\x1b[30m) news service Init ... \x1b[31mBad\x1b[30m   |");
	...
	{
		printf("\x1b[11;5H|  Set screen light level 5 ... \x1b[32mGood\x1b[30m      |");
		printf("\x1b[17;33H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[11;5H|  Set screen light level 5 ... \x1b[31mBad\x1b[30m       |");
	...
	if (apt_init_succes)
	{
		...
		{
			printf("\x1b[12;5H|  Set system core limit 30%% ... \x1b[32mGood\x1b[30m     |");
			printf("\x1b[17;34H\x1b[32mo\x1b[30m");
		}
		else
		{
			printf("\x1b[12;5H|  Set system core limit 30%% ... \x1b[31mBad\x1b[30m      |");
			printf("\x1b[17;34H\x1b[31mx\x1b[30m");
		}
	}
	else
	{
		printf("\x1b[12;5H|  Set system core limit 30%% ... \x1b[31mSkipped\x1b[30m  |");
		printf("\x1b[17;34H\x1b[31mx\x1b[30m");
	}
	...
	if (apt_init_succes)
	{
		...
		{
			printf("\x1b[13;5H|  Set system core limit 70%% ... \x1b[32mGood\x1b[30m     |");
			printf("\x1b[17;35H\x1b[32mo\x1b[30m");
		}
		else
		{
			printf("\x1b[13;5H|  Set system core limit 70%% ... \x1b[31mBad\x1b[30m      |");
			printf("\x1b[17;35H\x1b[31mx\x1b[30m");
		}
	}
	else
	{
		printf("\x1b[13;5H|  Set system core limit 70%% ... \x1b[31mSkipped\x1b[30m  |");
		printf("\x1b[17;35H\x1b[31mx\x1b[30m");
	}
	...
	{
		printf("\x1b[14;5H|  Start cpu load Thread 0 ... \x1b[32mGood\x1b[30m       |");
		printf("\x1b[17;36H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[14;5H|  Start cpu load Thread 0 ... \x1b[31mBad\x1b[30m        |");
	...
	{
		printf("\x1b[15;5H|  Start cpu load Thread 1 ... \x1b[32mGood\x1b[30m       |");
		printf("\x1b[17;37H\x1b[32mo\x1b[30m");
	}
	else
	{
		printf("\x1b[15;5H|  Start cpu load Thread 1 ... \x1b[31mBad\x1b[30m        |");
		printf("\x1b[17;37H\x1b[31mx\x1b[30m");
	}

	usleep(main_sleep);
	printf("\x1b[17;40H\x1b[32mDone\x1b[30m");
	...
	while (true)
	{
		...
		consoleSelect(&Screen_top);
		printf("\x1b[19;5H|            %s             |", battery_mark_mode[battery_mark_select_num]);

		if (battery_mark_init_succes)
		{
			if (battery_mark_select_num == 0)
			{
				printf("\x1b[20;5H|    This mode will using 85%% battery     |");
				printf("\x1b[21;5H|    Your current battery level = %02d%%     |", battery_level);
				if (battery_level > 86)
				{
					printf("\x1b[22;5H|          \x1b[32mYou can this test now\x1b[30m          |");
					printf("\x1b[23;5H|      \x1b[32mPress A to start battery mark\x1b[30m      |");
				...
				{
					printf("\x1b[22;5H|        \x1b[31mYou can't this test now\x1b[30m          |");
					printf("\x1b[23;5H|   \x1b[31mPlease charge battery and try again\x1b[30m   |");
			...
			{
				printf("\x1b[20;5H|    This mode will using 10%% battery     |");
				printf("\x1b[21;5H|    Your current battery level = %02d%%     |", battery_level);
				if (battery_level > 11)
				{
					printf("\x1b[22;5H|          \x1b[32mYou can this test now\x1b[30m          |");
			...
			{
				printf("\x1b[20;5H|    This mode will using 05%% battery     |");
				printf("\x1b[21;5H|    Your current battery level = %02d%%     |", battery_level);
				if (battery_level > 6)
				{
					printf("\x1b[22;5H|          \x1b[32mYou can this test now\x1b[30m          |");
		...
		{
			printf("\x1b[20;5H|     \x1b[31mYou must Init Required service\x1b[30m      |");
			printf("\x1b[22;5H|         \x1b[31mYou can't this test now\x1b[30m         |");
			battery_mark_full = false;
			battery_mark_short = false;
			battery_mark_very_short = false;
		...
		if (key & KEY_A)
		{
			if (battery_mark_short || battery_mark_full || battery_mark_very_short)
			{
		...
		{
			battery_mark_select_num = battery_mark_select_num + 1;
			if (battery_mark_select_num > 2)
			{
				battery_mark_select_num = 2;
			}
		}
	}
}
...
void Battery_mark(void)
{
	while (true)
	{
		...
		printf("\x1b[4;5H-------------------------------------------");
		printf("\x1b[5;5H|              \x1b[36mBattery mark\x1b[30m               |");
		printf("\x1b[6;5H| Current time,battery[%02d:%02d:%02d] %02d%% %.2fv|", hours, minutes, seconds, battery_level, battery_voltage_calculate);
		printf("\x1b[7;5H| Battery mark start  [%02d:%02d:%02d] %02d%% %.2fv|", battery_mark_start_time_hours, battery_mark_start_time_minutes, battery_mark_start_time_seconds, battery_mark_battery_level_start, battery_mark_battery_voltage_start);
		printf("\x1b[8;5H| Battery mark end    [%02d:%02d:%02d] %02d%% %.2fv|", battery_mark_end_time_hours, battery_mark_end_time_minutes, battery_mark_end_time_seconds, battery_mark_battery_level_end, battery_mark_battery_voltage_end);
		printf("\x1b[9;5H| Battery mark mode : %s    |", battery_mark_mode[battery_mark_select_num]);
		printf("\x1b[11;5H|                                         |");
		printf("\x1b[12;5H| Battery decrease 1%% \x1b[31mmin\x1b[30m :    [%02d:%02d]    |", battery_mark_min_time_minutes, battery_mark_min_time_seconds);
		printf("\x1b[13;5H| Battery decrease 1%% \x1b[32mmax\x1b[30m :    [%02d:%02d]    |", battery_mark_max_time_minutes, battery_mark_max_time_seconds);
		printf("\x1b[14;5H| Battery decrease 1%% avg :    [%02d:%02d]    |", battery_mark_avg_time_minutes, battery_mark_avg_time_seconds);
		printf("\x1b[15;5H| Elapsed time            :    [%02d:%02d]    |", battery_mark_time_count_minutes, battery_mark_time_count_seconds);
		printf("\x1b[16;5H| Total elapsed time      : [%02d:%02d:%02d]    |", battery_mark_total_time_hours, battery_mark_total_time_minutes, battery_mark_total_time_seconds);
		printf("\x1b[17;5H| Time left (estimated)   : [%02d:%02d:%02d]    |", battery_mark_left_time_hours, battery_mark_left_time_minutes, battery_mark_left_time_seconds);
		printf("\x1b[18;5H|                                         |");
		printf("\x1b[19;5H|               \x1b[31m!!Warning!!\x1b[30m               |");
		printf("\x1b[20;5H| \x1b[31mDon't charge battery while battery mark\x1b[30m |");
		printf("\x1b[21;5H|  \x1b[31mBattery mark will abort if you do it\x1b[30m   |");
		printf("\x1b[22;5H|                                         |");
		printf("\x1b[23;5H|                                         |");
		printf("\x1b[24;5H|               \x1b[32m<B>\x1b[30mGo back                |");
		printf("\x1b[25;5H-------------------------------------------");
		if (battery_charge == 1)
		{
		...
		if (battery_mark_running)
		{
			...
			printf("\x1b[10;5H| State : %s                    |", battery_mark_run_msg[battery_mark_count]);
		...
		{
			printf("\x1b[10;5H| State : \x1b[31mAborted : don't charge battery\x1b[30m  |");
		}
		else if (battery_mark_finish)
		{
			printf("\x1b[10;5H| State : \x1b[32mFinished\x1b[30m                        |");
		}
		else
		{
			printf("\x1b[10;5H| State : Wait for decreasing to %02d%%      |", battery_mark_battery_level_start);
...
int main()
{
	...
	while (aptMainLoop())
	{
		...
		else if (kDown & KEY_L && kDown & KEY_R)
		{
			Battery_mark_init();
		}
